...
Because the repo is private, pacman can't fetch the release assets on its own. A
small `XferCommand` wrapper adds a GitHub token for `github.com` downloads. Set it
up once:
